      ...
      try {
        ...
        if (data) {
          setFormData({
            ...
            footer_contact_email: data.footer_contact_email || 'ureportcocody01@hotmail.com',
            ...
            newsletter_receiver_email: data.newsletter_receiver_email || data.footer_contact_email || 'ureportcocody01@hotmail.com',
