...
create table if not exists members (
  ...
  trusted_device_token text default '',
...
create table if not exists settings (
  ...
  footer_contact_email text not null default 'ureportcocody01@hotmail.com',
  ...
  newsletter_receiver_email text not null default 'ureportcocody01@hotmail.com',
